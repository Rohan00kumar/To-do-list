...
function DisplayTodos () {
	...
	todos.forEach(todo => {
		...
		if (todo.category == 'high') {
			...
			span.classList.add('Weekly');
		}
		else if (todo.category == 'Monthly') {
			span.classList.add('Monthly');
		}
		else {
		...
		content.innerHTML = `<input type="text" content="width=device-width, initial-scale=1.0" value="${todo.content}" readonly>`;
